...
const Detail = ({ Category, id, color }) => {
...
{/* <a target="_blank" href={`https://web.whatsapp.com/send?text=${heading}+${currentPageUrl}&image=BASE64_ENCODED_IMAGE`} rel="nofollow">

                                                <WhatsappIcon size={42} round />
                                            </a>
                                            <WhatsappShareButton url={currentPageUrl} ImageUrl={`${API}${data.Image}`} title={heading} windowWidth={660} windowHeight={460}>
